...
import { posts as allPosts, Post } from '@/data/dummyData';
...
import { Plus, Pencil, Trash2, Eye, FileText, Send, Save, Search } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Buat dan kelola berita sekolah</p>
        </div>
      ...
      <Tabs defaultValue="all">
        <TabsList>
          <TabsTrigger value="all">Semua ({filteredPosts.length})</TabsTrigger>
