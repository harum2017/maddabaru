...
// Interface untuk struktur kelas (sinkron dengan ClassManagement)
...
// Default grade levels berdasarkan jenjang (sumber utama)
export const getDefaultGradeLevels = (level: SchoolLevel): GradeLevel[] => {
  switch (level) {
    case 'SD':
      return [
...
// Helper: Get classes by school level (menggunakan format nama rombel yang konsisten)
export const getClassesByLevel = (level: SchoolLevel): string[] => {
  const gradeLevels = getDefaultGradeLevels(level);
  const classes: string[] = [];
  
  gradeLevels.forEach(grade => {
    grade.sections.forEach(section => {
      classes.push(`${grade.romanNumeral}-${section.name}`);
    });
  });
...
export const staff: Staff[] = [
  ...
  { id: 10, school_id: 2, name: "Ir. Bambang Hermawan, M.T.", position: "Kepala Sekolah", class_or_subject: "-", nip: "196708101992031001", phone: "08111222333", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop" },
  { id: 11, school_id: 2, name: "Drs. Sugeng Widodo, M.M.", position: "Wakil Kepala Sekolah", class_or_subject: "Kesiswaan", nip: "197205151994031002", phone: "08111222334", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=400&h=400&fit=crop" },
  { id: 12, school_id: 2, name: "Ratna Sari, S.T.", position: "Guru", class_or_subject: "Teknik Komputer", nip: "198203151996032002", phone: "08789012345", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400&h=400&fit=crop" },
  { id: 13, school_id: 2, name: "Agus Prabowo, S.T.", position: "Guru", class_or_subject: "Teknik Mesin", nip: "198506202000031003", phone: "08890123456", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=400&h=400&fit=crop" },
  { id: 14, school_id: 2, name: "Maya Kusuma, S.Pd.", position: "Guru", class_or_subject: "Bahasa Inggris Teknik", nip: "198709102005042004", phone: "08901234567", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=400&h=400&fit=crop" },
  { id: 15, school_id: 2, name: "Eko Prasetyo, S.T.", position: "Guru", class_or_subject: "Teknik Listrik", nip: "198811152007031005", phone: "08012345678", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1504257432389-52343af06ae3?w=400&h=400&fit=crop" },
  { id: 16, school_id: 2, name: "Sri Wahyuni", position: "Tata Usaha", class_or_subject: "-", nip: "199002202010012006", phone: "08123456780", address: "Kota Mandiri", is_public: true, photo: "https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400&h=400&fit=crop" },
  { id: 17, school_id: 2, name: "Dewi Kartika", position: "Operator Website", class_or_subject: "-", nip: "199305102016012007", phone: "08234567801", address: "Kota Mandiri", is_public: false, photo: "https://images.unsplash.com/photo-1524504388940-b1c1722653e1?w=400&h=400&fit=crop" },

  // Staff Sekolah 3 - SMP Harapan Bangsa
  { id: 18, school_id: 3, name: "Drs. Hendra Wijaya, M.M.", position: "Kepala Sekolah", class_or_subject: "-", nip: "196905051993031001", phone: "08333444555", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop" },
  { id: 19, school_id: 3, name: "Hj. Fatimah, S.Pd., M.Pd.", position: "Wakil Kepala Sekolah", class_or_subject: "Kurikulum", nip: "197408081995032002", phone: "08333444556", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1598550874175-4d0ef436c909?w=400&h=400&fit=crop" },
  { id: 20, school_id: 3, name: "Ahmad Fauzi, S.Pd.I", position: "Guru", class_or_subject: "Pendidikan Agama", nip: "198001012002031003", phone: "08444555666", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400&h=400&fit=crop" },
  { id: 21, school_id: 3, name: "Nurul Hidayah, S.Pd.", position: "Guru", class_or_subject: "Matematika", nip: "198512152008042004", phone: "08555666777", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1594744803329-e58b31de8bf5?w=400&h=400&fit=crop" },
  { id: 22, school_id: 3, name: "Andi Setiawan, S.Pd.", position: "Guru", class_or_subject: "IPA", nip: "198704202010011005", phone: "08666777888", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1463453091185-61582044d556?w=400&h=400&fit=crop" },
  { id: 23, school_id: 3, name: "Lina Marlina, S.Pd.", position: "Guru", class_or_subject: "Bahasa Indonesia", nip: "198909102012042006", phone: "08777888999", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&h=400&fit=crop" },
  { id: 24, school_id: 3, name: "Yusuf Maulana", position: "Tata Usaha", class_or_subject: "-", nip: "199105152014011007", phone: "08888999000", address: "Kota Sejahtera", is_public: true, photo: "https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?w=400&h=400&fit=crop" },
  { id: 25, school_id: 3, name: "Putri Rahayu", position: "Operator Website", class_or_subject: "-", nip: "199407202017012008", phone: "08999000111", address: "Kota Sejahtera", is_public: false, photo: "https://images.unsplash.com/photo-1517841905240-472988babdf9?w=400&h=400&fit=crop" },

  // Staff Sekolah 4 - SD Negeri Cendekia
  { id: 26, school_id: 4, name: "Dra. Kartini Dewi, M.Pd.", position: "Kepala Sekolah", class_or_subject: "-", nip: "196803151990032001", phone: "08211223344", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=400&h=400&fit=crop" },
  { id: 27, school_id: 4, name: "Hj. Nurhasanah, S.Pd.", position: "Wakil Kepala Sekolah", class_or_subject: "Kurikulum", nip: "197506201996032002", phone: "08211223345", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1551836022-d5d88e9218df?w=400&h=400&fit=crop" },
  { id: 28, school_id: 4, name: "Rina Susanti, S.Pd.", position: "Guru", class_or_subject: "Guru Kelas I", nip: "198201102005042003", phone: "08322334455", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=400&h=400&fit=crop" },
  { id: 29, school_id: 4, name: "Ani Wijayanti, S.Pd.", position: "Guru", class_or_subject: "Guru Kelas II", nip: "198405152008042004", phone: "08433445566", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1567532939604-b6b5b0db2604?w=400&h=400&fit=crop" },
  { id: 30, school_id: 4, name: "Budi Hartono, S.Pd.", position: "Guru", class_or_subject: "Guru Kelas III", nip: "198608202010011005", phone: "08544556677", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1492562080023-ab3db95bfbce?w=400&h=400&fit=crop" },
  { id: 31, school_id: 4, name: "Sari Indrawati, S.Pd.", position: "Guru", class_or_subject: "Guru Kelas IV", nip: "198710252012042006", phone: "08655667788", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?w=400&h=400&fit=crop" },
  { id: 32, school_id: 4, name: "Dedi Kurniawan, S.Pd.", position: "Guru", class_or_subject: "Guru Kelas V", nip: "198901302014011007", phone: "08766778899", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1507591064344-4c6ce005b128?w=400&h=400&fit=crop" },
  { id: 33, school_id: 4, name: "Maya Sari, S.Pd.", position: "Guru", class_or_subject: "Guru Kelas VI", nip: "199004052016042008", phone: "08877889900", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1489424731084-a5d8b219a5bb?w=400&h=400&fit=crop" },
  { id: 34, school_id: 4, name: "Agus Santoso, S.Pd.", position: "Guru", class_or_subject: "Pendidikan Jasmani", nip: "198706102010011009", phone: "08988990011", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?w=400&h=400&fit=crop" },
  { id: 35, school_id: 4, name: "Usman Hidayat", position: "Tata Usaha", class_or_subject: "-", nip: "199205102014011010", phone: "08199001122", address: "Kota Pintar", is_public: true, photo: "https://images.unsplash.com/photo-1542909168-82c3e7fdca5c?w=400&h=400&fit=crop" },
  { id: 36, school_id: 4, name: "Wati Lestari", position: "Operator Website", class_or_subject: "-", nip: "199508152018012011", phone: "08200112233", address: "Kota Pintar", is_public: false, photo: "https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?w=400&h=400&fit=crop" },
];
...
export const students: Student[] = [
  ...
  // Kelas: VII-A s/d VII-G, VIII-A s/d VIII-G, IX-A s/d IX-G
  // =====================================================
  { id: 36, school_id: 3, name: "Ahmad Zaki", class: "IX-A", nis: "2021201", gender: "L", parent_name: "Bapak Zaki", parent_phone: "08555666777" },
  { id: 37, school_id: 3, name: "Siti Nurhaliza", class: "IX-B", nis: "2021202", gender: "P", parent_name: "Ibu Nurhaliza", parent_phone: "08666777888" },
  { id: 38, school_id: 3, name: "Bagus Pratama", class: "IX-C", nis: "2021203", gender: "L", parent_name: "Bapak Bagus", parent_phone: "08666777889" },
  { id: 39, school_id: 3, name: "Cinta Amalia", class: "IX-D", nis: "2021204", gender: "P", parent_name: "Ibu Cinta", parent_phone: "08666777890" },
  { id: 40, school_id: 3, name: "Doni Saputra", class: "IX-E", nis: "2021205", gender: "L", parent_name: "Bapak Doni", parent_phone: "08666777891" },
  { id: 41, school_id: 3, name: "Evi Susanti", class: "IX-F", nis: "2021206", gender: "P", parent_name: "Ibu Evi", parent_phone: "08666777892" },
  { id: 42, school_id: 3, name: "Fandi Ahmad", class: "IX-G", nis: "2021207", gender: "L", parent_name: "Bapak Fandi", parent_phone: "08666777893" },
  { id: 43, school_id: 3, name: "Raka Aditya", class: "VIII-A", nis: "2022201", gender: "L", parent_name: "Bapak Aditya", parent_phone: "08777888999" },
  { id: 44, school_id: 3, name: "Gita Nirmala", class: "VIII-B", nis: "2022202", gender: "P", parent_name: "Ibu Gita", parent_phone: "08777889000" },
  { id: 45, school_id: 3, name: "Hari Prasetyo", class: "VIII-C", nis: "2022203", gender: "L", parent_name: "Bapak Hari", parent_phone: "08777889001" },
  { id: 46, school_id: 3, name: "Putri Wulandari", class: "VIII-D", nis: "2022204", gender: "P", parent_name: "Ibu Wulandari", parent_phone: "08100111222" },
  { id: 47, school_id: 3, name: "Ivan Ramadhan", class: "VIII-E", nis: "2022205", gender: "L", parent_name: "Bapak Ivan", parent_phone: "08777889003" },
  { id: 48, school_id: 3, name: "Aulia Rahmawati", class: "VII-A", nis: "2023201", gender: "P", parent_name: "Ibu Rahmawati", parent_phone: "08888999000" },
  { id: 49, school_id: 3, name: "Kiki Fatimah", class: "VII-B", nis: "2023202", gender: "P", parent_name: "Ibu Kiki", parent_phone: "08888999001" },
  { id: 50, school_id: 3, name: "Dimas Prasetyo", class: "VII-C", nis: "2023203", gender: "L", parent_name: "Bapak Prasetyo", parent_phone: "08999000111" },
  { id: 51, school_id: 3, name: "Luki Hermawan", class: "VII-D", nis: "2023204", gender: "L", parent_name: "Bapak Luki", parent_phone: "08888999003" },
  { id: 52, school_id: 3, name: "Mira Anggraini", class: "VII-E", nis: "2023205", gender: "P", parent_name: "Ibu Mira", parent_phone: "08888999004" },
  { id: 53, school_id: 3, name: "Nanda Putra", class: "VII-F", nis: "2023206", gender: "L", parent_name: "Bapak Nanda", parent_phone: "08888999005" },
